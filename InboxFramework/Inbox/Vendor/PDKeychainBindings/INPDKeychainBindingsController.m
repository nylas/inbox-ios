...
static INPDKeychainBindingsController *sharedInstance = nil;

@implementation INPDKeychainBindingsController
...
- (INPDKeychainBindings *) keychainBindings {
    if (_keychainBindings == nil) {
        _keychainBindings = [[INPDKeychainBindings alloc] init]; 
    }
    if (_valueBuffer==nil) {
